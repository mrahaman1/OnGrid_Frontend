...
const Navbar = () => {
  ...
  useEffect(()=>{
    fetch("https://ongridbackend.onrender.com/userdetails",{
  method:"POST",
...
.then(data=>setUserdata(data.data))
  ...
  return (
    <div >
        ...
        <div className='loginname'>{isLoggedIn ? <button className='d '><NavLink to='/userdetails' className='notactive-class'>Hi {userdata.username}</NavLink></button> : ""}
            </div>
        </div>
        </div>
        {/* {drop &&  } */}
